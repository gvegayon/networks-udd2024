...
1. Write a function to simulate Bernoulli graph, but instead of evaluating each $(i,j)$ tie individually like in @01-er-random, use a binomial random number to identify how many edges the graph will have, and randomly pick which will those be from the set $V\times V$
