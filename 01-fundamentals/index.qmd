...
Part of statistical inference is hypothesis testing. According to Wikipedia
...
3. Compare the observed test statistic with the distribution of the test statistic under the null hypothesis. The sometimes infamous p-value: The probability the observed statistic comes from the null.

4. Report the observed p-value.

As scientists, we either reject the null hypothesis or fail to reject it. We never accept the null hypothesis.
