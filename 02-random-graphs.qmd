...
::: {.callout-note title="When to stop"}
In @rayAreWeThere2012, the authors provide a simple reference for when to stop the MCMC process that generates random graphs via rewiring. Instead of using $|E|\times 100$, they suggest something closer to $|E|\times 16$.
:::
